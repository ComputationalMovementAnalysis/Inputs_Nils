...
- You will not be needing Git and Github today! This input is a preperation for next week
- In preparation for submitting the `R` exercise 2 with Git / Github, do the following:

  - Create a Github account if you don't have one already. Some tips on choosing a name:
    - consider incorporating your actual name
    - make sure you are comfortable revealing it to a future boss
    - shorter > longer
    - make it timeless
- Decide if you want are motivated enough to set up everything on your local computer (laptop) or if you want to take the easy route and work on the server
  - we recommend working on your local computer, but are limited to how much we can specifically help in case of installation problems
